...
const std::map<std::string, unsigned int> L1TPhase2CorrelatorOffline::PlotConfigNames = {
    {"resVsPt", PlotConfig::resVsPt}, {"resVsEta", PlotConfig::resVsEta}, {"ptDist", PlotConfig::ptDist}, {"etaDist", PlotConfig::etaDist}};

//
// -------------------------------------- Constructor --------------------------------------------
//
L1TPhase2CorrelatorOffline::L1TPhase2CorrelatorOffline(const edm::ParameterSet& ps)
    : phase2PFToken_(consumes<std::vector<l1t::PFCandidate>>(ps.getUntrackedParameter<edm::InputTag>("phase2L1PfInputTag"))),
      phase2PuppiToken_(consumes<std::vector<l1t::PFCandidate>>(ps.getUntrackedParameter<edm::InputTag>("phase2L1PuppiInputTag"))),
...
L1TPhase2CorrelatorOffline::~L1TPhase2CorrelatorOffline() {
  edm::LogInfo("L1TPhase2CorrelatorOffline") << "Destructor L1TPhase2CorrelatorOffline::~L1TPhase2CorrelatorOffline " << std::endl;
}
...
void L1TPhase2CorrelatorOffline::bookPhase2CorrelatorHistos(DQMStore::IBooker& ibooker) {
  ...
  h_L1Puppi_pt_mu_ = ibooker.book1D("Puppi_pt_mu", "L1 PUPPI Muon p_{T}", ptDistDef.nbinsX, ptDistDef.xmin, ptDistDef.xmax);
  h_L1Puppi_eta_mu_ = ibooker.book1D("Puppi_eta_mu", "L1 PUPPI Muon #eta", etaDistDef.nbinsX, etaDistDef.xmin, etaDistDef.xmax);

  h_L1PF_pt_el_ = ibooker.book1D("PF_pt_el", "L1 PF Electron p_{T}", ptDistDef.nbinsX, ptDistDef.xmin, ptDistDef.xmax);
  h_L1PF_eta_el_ = ibooker.book1D("PF_eta_el", "L1 PF Electron #eta", etaDistDef.nbinsX, etaDistDef.xmin, etaDistDef.xmax);
  h_L1Puppi_pt_el_ = ibooker.book1D("Puppi_pt_el", "L1 PUPPI Electron p_{T}", ptDistDef.nbinsX, ptDistDef.xmin, ptDistDef.xmax);
  h_L1Puppi_eta_el_ = ibooker.book1D("Puppi_eta_el", "L1 PUPPI Electron #eta", etaDistDef.nbinsX, etaDistDef.xmin, etaDistDef.xmax);

  h_L1PF_pt_pho_ = ibooker.book1D("PF_pt_pho", "L1 PF Photon p_{T}", ptDistDef.nbinsX, ptDistDef.xmin, ptDistDef.xmax);
  h_L1PF_eta_pho_ = ibooker.book1D("PF_eta_pho", "L1 PF Photon #eta", etaDistDef.nbinsX, etaDistDef.xmin, etaDistDef.xmax);
  h_L1Puppi_pt_pho_ = ibooker.book1D("Puppi_pt_pho", "L1 PUPPI Photon p_{T}", ptDistDef.nbinsX, ptDistDef.xmin, ptDistDef.xmax);
  h_L1Puppi_eta_pho_ = ibooker.book1D("Puppi_eta_pho", "L1 PUPPI Photon #eta", etaDistDef.nbinsX, etaDistDef.xmin, etaDistDef.xmax);

  h_L1PF_pt_ch_ = ibooker.book1D("PF_pt_ch", "L1 PF Charged Hadron p_{T}", ptDistDef.nbinsX, ptDistDef.xmin, ptDistDef.xmax);
  h_L1PF_eta_ch_ = ibooker.book1D("PF_eta_ch", "L1 PF Charged Hadron #eta", etaDistDef.nbinsX, etaDistDef.xmin, etaDistDef.xmax);
  h_L1Puppi_pt_ch_ = ibooker.book1D("Puppi_pt_ch", "L1 PUPPI Charged Hadron p_{T}", ptDistDef.nbinsX, ptDistDef.xmin, ptDistDef.xmax);
  h_L1Puppi_eta_ch_ = ibooker.book1D("Puppi_eta_ch", "L1 PUPPI Charged Hadron #eta", etaDistDef.nbinsX, etaDistDef.xmin, etaDistDef.xmax);

  h_L1PF_pt_nh_ = ibooker.book1D("PF_pt_nh", "L1 PF Neutral Hadron p_{T}", ptDistDef.nbinsX, ptDistDef.xmin, ptDistDef.xmax);
  h_L1PF_eta_nh_ = ibooker.book1D("PF_eta_nh", "L1 PF Neutral Hadron #eta", etaDistDef.nbinsX, etaDistDef.xmin, etaDistDef.xmax);
  h_L1Puppi_pt_nh_ = ibooker.book1D("Puppi_pt_nh", "L1 PUPPI Neutral Hadron p_{T}", ptDistDef.nbinsX, ptDistDef.xmin, ptDistDef.xmax);
  h_L1Puppi_eta_nh_ = ibooker.book1D("Puppi_eta_nh", "L1 PUPPI Neutral Hadron #eta", etaDistDef.nbinsX, etaDistDef.xmin, etaDistDef.xmax);
  ...
  h_L1PF_electron_ptratio_0p2_vs_pt_barrel_ = ibooker.book2D("L1PFElectronPtRatio0p2VsPtBarrel",
                                        ...
                                        resVsPtDef.nbinsX, resVsPtDef.xmin, resVsPtDef.xmax,
                                        ptratio_nbins, ptratio_lo, ptratio_hi);
  ...
  h_L1PF_electron_ptratio_0p2_vs_pt_ecnotk_ = ibooker.book2D("L1PFElectronPtRatio0p2VsPtEndcapNoTk",
  ...
  h_L1Puppi_electron_ptratio_0p2_vs_pt_barrel_ = ibooker.book2D("L1PUPPIElectronPtRatio0p2VsPtBarrel",
                                        "L1 PUPPI Electron L1/Gen (#Delta R < 0.2) vs p_{T}, Barrel",
                                        resVsPtDef.nbinsX, resVsPtDef.xmin, resVsPtDef.xmax,
                                        ptratio_nbins, ptratio_lo, ptratio_hi);

  h_L1Puppi_electron_ptratio_0p2_vs_pt_endcap_ = ibooker.book2D("L1PUPPIElectronPtRatio0p2VsPtEndcap",
                                        "L1 PUPPI Electron L1/Gen (#Delta R < 0.2) vs p_{T}, Endcap",
                                        resVsPtDef.nbinsX, resVsPtDef.xmin, resVsPtDef.xmax,
                                        ptratio_nbins, ptratio_lo, ptratio_hi);

  h_L1Puppi_electron_ptratio_0p2_vs_pt_ecnotk_ = ibooker.book2D("L1PUPPIElectronPtRatio0p2VsPtEndcapNoTk",
  ...
  h_L1Puppi_electron_ptratio_best_vs_pt_ecnotk_ = ibooker.book2D("L1PUPPIElectronPtRatioBestVsPtEndcapNoTk",
  ...
  h_L1Puppi_pizero_ptratio_0p2_vs_pt_ecnotk_ = ibooker.book2D("L1PUPPIPi0PtRatio0p2VsPtEndcapNoTk",
  ...
  h_L1Puppi_pion_ptratio_0p2_vs_pt_ecnotk_ = ibooker.book2D("L1PUPPIPionPtRatio0p2VsPtEndcapNoTk",
...
//Response
  ...
  h_L1PF_electron_response_0p2_pt_ecnotk_ = ibooker.book1D("L1PFElectronResponse0p2VsPtEndcapNoTk",
  ...
  h_L1Puppi_electron_response_0p2_pt_barrel_ = ibooker.book1D("L1PUPPIElectronResponse0p2VsPtBarrel",
                                        "L1 PUPPI Electron Response (#Delta R < 0.2) vs p_{T}, Barrel",
                                        resVsPtDef.nbinsX, resVsPtDef.xmin, resVsPtDef.xmax);

  h_L1Puppi_electron_response_0p2_pt_endcap_ = ibooker.book1D("L1PUPPIElectronResponse0p2VsPtEndcap",
                                        "L1 PUPPI Electron Response (#Delta R < 0.2) vs p_{T}, Endcap",
                                        resVsPtDef.nbinsX, resVsPtDef.xmin, resVsPtDef.xmax);

  h_L1Puppi_electron_response_0p2_pt_ecnotk_ = ibooker.book1D("L1PUPPIElectronResponse0p2VsPtEndcapNoTk",
  ...
  h_L1Puppi_electron_response_best_pt_ecnotk_ = ibooker.book1D("L1PUPPIElectronResponseBestVsPtEndcapNoTk",
  ...
  h_L1Puppi_pizero_response_0p2_pt_ecnotk_ = ibooker.book1D("L1PUPPIPi0Response0p2VsPtEndcapNoTk",
  ...
  h_L1Puppi_pion_response_0p2_pt_ecnotk_ = ibooker.book1D("L1PUPPIPionResponse0p2VsPtEndcapNoTk",
  ...
  h_L1PF_jet_response_pt_hf_ = ibooker.book1D("L1PFJetResponseVsPtHF",
                                        "L1 PF Jet Response vs p_{T}, HF",
                                        resVsPtDef.nbinsX, resVsPtDef.xmin, resVsPtDef.xmax);

  h_L1PF_jet_response_eta_ = ibooker.book1D("L1PFJetResponseVsEta",
                                        "L1 PF Jet Response vs #eta",
                                        resVsEtaDef.nbinsX, resVsEtaDef.xmin, resVsEtaDef.xmax);
...
//Resolution
  h_L1PF_electron_resolution_0p2_pt_barrel_ = ibooker.book1D("L1PFElectronResolution0p2VsPtBarrel",
                                        "L1 PF Electron Resolution (#Delta R < 0.2) vs p_{T}, Barrel",
                                        resVsPtDef.nbinsX, resVsPtDef.xmin, resVsPtDef.xmax);

  h_L1PF_electron_resolution_0p2_pt_endcap_ = ibooker.book1D("L1PFElectronResolution0p2VsPtEndcap",
                                        "L1 PF Electron Resolution (#Delta R < 0.2) vs p_{T}, Endcap",
                                        resVsPtDef.nbinsX, resVsPtDef.xmin, resVsPtDef.xmax);

  h_L1PF_electron_resolution_0p2_pt_ecnotk_ = ibooker.book1D("L1PFElectronResolution0p2VsPtEndcapNoTk",
  ...
  h_L1Puppi_electron_resolution_0p2_pt_barrel_ = ibooker.book1D("L1PUPPIElectronResolution0p2VsPtBarrel",
                                        "L1 PUPPI Electron Resolution (#Delta R < 0.2) vs p_{T}, Barrel",
                                        resVsPtDef.nbinsX, resVsPtDef.xmin, resVsPtDef.xmax);

  h_L1Puppi_electron_resolution_0p2_pt_endcap_ = ibooker.book1D("L1PUPPIElectronResolution0p2VsPtEndcap",
                                        "L1 PUPPI Electron Resolution (#Delta R < 0.2) vs p_{T}, Endcap",
                                        resVsPtDef.nbinsX, resVsPtDef.xmin, resVsPtDef.xmax);

  h_L1Puppi_electron_resolution_0p2_pt_ecnotk_ = ibooker.book1D("L1PUPPIElectronResolution0p2VsPtEndcapNoTk",
                                        "L1 PUPPI Electron Resolution (#Delta R < 0.2) vs p_{T}, Endcap No Tk",
                                        resVsPtDef.nbinsX, resVsPtDef.xmin, resVsPtDef.xmax);

  h_L1Puppi_electron_resolution_0p2_pt_hf_ = ibooker.book1D("L1PUPPIElectronResolution0p2VsPtHF",
  ...
  h_L1Puppi_electron_resolution_best_pt_ecnotk_ = ibooker.book1D("L1PUPPIElectronResolutionBestVsPtEndcapNoTk",
  ...
  h_L1PF_pizero_resolution_0p2_pt_ecnotk_ = ibooker.book1D("L1PFPi0Resolution0p2VsPtEndcapNoTk",
  ...
  h_L1Puppi_pizero_resolution_0p2_pt_barrel_ = ibooker.book1D("L1PUPPIPi0Resolution0p2VsPtBarrel",
                                        "L1 PUPPI Pi0 Resolution (#Delta R < 0.2) vs p_{T}, Barrel",
                                        resVsPtDef.nbinsX, resVsPtDef.xmin, resVsPtDef.xmax);

  h_L1Puppi_pizero_resolution_0p2_pt_endcap_ = ibooker.book1D("L1PUPPIPi0Resolution0p2VsPtEndcap",
                                        "L1 PUPPI Pi0 Resolution (#Delta R < 0.2) vs p_{T}, Endcap",
                                        resVsPtDef.nbinsX, resVsPtDef.xmin, resVsPtDef.xmax);

  h_L1Puppi_pizero_resolution_0p2_pt_ecnotk_ = ibooker.book1D("L1PUPPIPi0Resolution0p2VsPtEndcapNoTk",
  ...
  h_L1PF_pion_resolution_0p2_pt_ecnotk_ = ibooker.book1D("L1PFPionResolution0p2VsPtEndcapNoTk",
  ...
  h_L1Puppi_pion_resolution_0p2_pt_barrel_ = ibooker.book1D("L1PUPPIPionResolution0p2VsPtBarrel",
                                        "L1 PUPPI Pion Resolution (#Delta R < 0.2) vs p_{T}, Barrel",
                                        resVsPtDef.nbinsX, resVsPtDef.xmin, resVsPtDef.xmax);

  h_L1Puppi_pion_resolution_0p2_pt_endcap_ = ibooker.book1D("L1PUPPIPionResolution0p2VsPtEndcap",
                                        "L1 PUPPI Pion Resolution (#Delta R < 0.2) vs p_{T}, Endcap",
                                        resVsPtDef.nbinsX, resVsPtDef.xmin, resVsPtDef.xmax);

  h_L1Puppi_pion_resolution_0p2_pt_ecnotk_ = ibooker.book1D("L1PUPPIPionResolution0p2VsPtEndcapNoTk",
...
void L1TPhase2CorrelatorOffline::computeResponseResolution() {
  std::vector<MonitorElement*> monElementstoComputeIn = {
    h_L1PF_electron_ptratio_0p2_vs_pt_barrel_,
    h_L1PF_electron_ptratio_0p2_vs_pt_endcap_,
    h_L1PF_electron_ptratio_0p2_vs_pt_ecnotk_,
    h_L1PF_electron_ptratio_0p2_vs_pt_hf_,
  ...
  std::vector<MonitorElement*> monElementstoComputeResp = {
    h_L1PF_electron_response_0p2_pt_barrel_,
  ...
  for (unsigned int i = 0; i < monElementstoComputeIn.size(); i++) {
    if (monElementstoComputeIn[i] != nullptr && monElementstoComputeResp[i] != nullptr && monElementstoComputeResol[i] != nullptr) {
      medianResponseCorrResolution(monElementstoComputeIn[i], monElementstoComputeResp[i], monElementstoComputeResol[i]);
    }
  ...
  if (h != nullptr && hresp != nullptr && hresol != nullptr) {
    if (h->GetNbinsX() == hresp->GetNbinsX() && h->GetNbinsX() == hresol->GetNbinsX()) {
      ...
      for (int ibx = 1; ibx < h->GetNbinsX()+1; ibx++) {
        hresol->SetBinContent(ibx,qc->GetBinContent(ibx) > 0.2 ? (qhi->GetBinContent(ibx) - qlo->GetBinContent(ibx))/2. : 0.);
      }
      delete qc;
      delete qhi;
      delete qlo;
...
void L1TPhase2CorrelatorOffline::normalise2DHistogramsToBinArea() {
  std::vector<MonitorElement*> monElementstoNormalize = {//h_L1PF_pt_vs_eta_,
                                                         };//h_L1Puppi_pt_vs_eta_};
